                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            ...
                            <!-- Added in the order they need to be added -->
                                ...
                                <!-- <li><a href="{{ route('admin.emojis.index') }}"><i class="fa fa-smile" aria-hidden="true"></i> Emoji </a></li> -->
                                <!-- <li><a href="{{ route('admin.emojis.index') }}"><i class="fa fa-child" aria-hidden="true"></i> Ratings </a></li> -->
